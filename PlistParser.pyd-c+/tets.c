...
#define __PYX_HAVE__tets
#define __PYX_HAVE_API__tets
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from 'tets' */
#define __Pyx_MODULE_NAME "tets"
extern int __pyx_module_is_main_tets;
int __pyx_module_is_main_tets = 0;

/* Implementation of 'tets' */
...
static const char __pyx_k_sadfasdff[] = "sadfasdff";
...
static PyObject *__pyx_n_s_sadfasdff;
static PyObject *__pyx_n_s_test;
static PyObject *__pyx_int_213312;
/* Late includes */
...
static int __pyx_pymod_exec_tets(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_tets},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_sadfasdff, __pyx_k_sadfasdff, sizeof(__pyx_k_sadfasdff), 0, 0, 1, 1},
...
static CYTHON_SMALL_CODE int __Pyx_InitGlobals(void) {
  ...
  __pyx_int_213312 = PyInt_FromLong(213312L); if (unlikely(!__pyx_int_213312)) __PYX_ERR(0, 3, __pyx_L1_error)
  return 0;
  __pyx_L1_error:;
  return -1;
}
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC inittets(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC inittets(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_tets(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_tets(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_tets(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'tets' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_tets(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("tets", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "tets")) {
      if (unlikely(PyDict_SetItemString(modules, "tets", __pyx_m) < 0)) __PYX_ERR(0, 3, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 * print('sadfasdff')
 */
  if (__Pyx_PrintOne(0, __pyx_int_213312) < 0) __PYX_ERR(0, 3, __pyx_L1_error)
 ...
 * print('sadfasdff')             # <<<<<<<<<<<<<<
 */
  if (__Pyx_PrintOne(0, __pyx_n_s_sadfasdff) < 0) __PYX_ERR(0, 4, __pyx_L1_error)
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init tets", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init tets");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
